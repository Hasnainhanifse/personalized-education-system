...
export default function Admin(props) {
  ...
  const [currentRoute, setCurrentRoute] = React.useState(PATHS.PATH_DASHBOARD);
  ...
  const getActiveRoute = (routes) => {
    let activeRoute = PATHS.PATH_DASHBOARD;
            ...
            <div className="pt-5s mx-auto mb-auto h-full min-h-[84vh] p-2 md:pr-2">
              <Routes>
                ...
                <Route
                  path="/"
                  element={
                    <Navigate to={LINKS.LINK_DASHBOARD} replace={true} />
                  }
                />
              </Routes>
            </div>
